...
PROCESSNAME="SNEAKRS-inhouse"
VOIPSUPPORTED="1"
FILESYSTEMSIZE="15248"
IOSVERSION="11.4"
MOBILECOUNTRYCODE="234" # mobile country code defined in https://www.itu.int/itudoc/itu-t/ob-lists/icc/e212_685.pdf, code 234 is for UK
APPID="com.nike.onenikecommerce.eu"
...
def generatefingerprint():
	...
	data = {
		"CURR": CURRENCY,
		"ICTKN": base64.b64encode('bplist00\xd4\x01\x02\x03\x04\x05\x06\t\nX$versionX$objectsY$archiverT$top\x12\x00\x01\x86\xa0\xa2\x07\x08U$nullO\x10\x14'+os.urandom(20)+'\xbf_\x10\x0fNSKeyedArchiver\xd1\x0b\x0cTroot\x80\x01\x08\x11\x1a#-27:@Wilq\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00s'),  # UbiquityIdentityToken(identity token for the icloud account the device is logged into) stored in NSKeyedArchiver format
